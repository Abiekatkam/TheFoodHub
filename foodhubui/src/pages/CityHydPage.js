...
function CityHydPage() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios(`${cityRouteName}Hyderabad`);
      ...
      <MenuContentSection>
        <div className="wrapper">
          ...
          <div id="content">
            ...
            <h2 className="head2">Best Restaurant List in Hyderabad.</h2>
