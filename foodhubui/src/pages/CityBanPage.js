...
function CityBanPage() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios(`${cityRouteName}Bangalore`);
      ...
      <MenuContentSection>
        <div className="wrapper">
          ...
          <div id="content">
            ...
            <h2 className="head2">Best Restaurant List in Bangalore.</h2>
